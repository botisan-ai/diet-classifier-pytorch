...
f = Flow(
    ...
    uses_with={
        ...
        'model_path': './lightning_logs/version_1/checkpoints/epoch=999-step=10000.ckpt',
...
with f:
    ...
    outputs.save_binary('part-1-embeddings.bin', protocol='pickle-array', compress='gzip')
    # for doc in outputs:
    #     doc.summary()
